...
纯白、极简、手绘、留白、克制、有趣、产品草图感、中文手写感、结构清楚但不说明书。
...
- 蓝紫色：Codex App 图标角色的云朵核心、补充说明、系统状态、第二层解释、AI/assistant/自动化提示。

蓝紫色不是每张都必须用在其他元素上。颜色要克制，宁可少不要多。
